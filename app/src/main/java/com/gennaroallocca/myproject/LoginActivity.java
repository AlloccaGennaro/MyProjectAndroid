...
public class LoginActivity extends Activity {
    ...
    Button login,cont,cont_code,cancel,cancell,register,forgpass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgpass = (Button)findViewById(R.id.forgotpass);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JSONObject json = sr.getJSON("http://10.160.13.42:5000/login",params);
            ...
            public void onClick(View view) {
                ...
                cont.setOnClickListener(new View.OnClickListener(){
                    ...
                    public void onClick(View view) {
                        ...
                        JSONObject json = sr.getJSON("http://10.160.13.42:5000/api/resetpass", params);
                        ...
                        if(json !=null) {
                            try {
                                ...
                                if(json.getBoolean("res")) {
                                    ...
                                    cancell = (Button)reset.findViewById(R.id.cancel);
                                    ...
                                    cont_code.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            ...
                                            JSONObject json = sr.getJSON("http://10.160.13.42:5000/api/resetpass/chg", params);
